...
const professors = [
<<<<<<< HEAD
    {avatar: IMGDIR+"/images/university/professors/professor-8.jpg", name: "Alan Smith", position: "Admin", facebook: "#!", twitter: "#!", linkedin: "#!", msg: 'After a slow start, blogging rapidly gained in popularity, blog usage spread.'},
...
=======
    {avatar: IMGDIR+"/images/university/professors/professor-8.jpg", name: "Alan Smith", position: "Docente", facebook: "#!", twitter: "#!", linkedin: "#!", msg: 'After a slow start, blogging rapidly gained in popularity, blog usage spread.'},
    {avatar: IMGDIR+"/images/university/professors/professor-6.jpg", name: "Blake Ross", position: "Coordinador Académico", facebook: "#!", twitter: "#!", linkedin: "#!", msg: 'Posts were made to appear in reverse chronological order by manually updating text based HTML.'},
>>>>>>> master
