    ...
    steps: [
      {
        title: (
          <div>
            <h6>
              El hombre que es un maestro de la paciencia es un maestro de todo
              lo demás (George Saville)
            </h6>
          </div>
        ),
        target: 'body',
        ...
        content: (
          <div>
            <h4>Vamos a seleccionar una Asignatura.</h4>
            <p>Arranquemos...!! </p>
          </div>
        ),
        disableBeacon: true,
      ...
      },
      {
        ...
        target: '.groupsCharge',
        content:
          'Seleccionamos el grupo, para conocer las actividades creadas.',
        locale: {
          back: 'Atras',
          close: 'Cerrar',
          last: 'Último',
