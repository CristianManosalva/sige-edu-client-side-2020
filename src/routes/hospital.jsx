...
var dashRoutes = [
  ...
  {
    path: BASEDIR + '/hospital/add-doctor',
    component: AddDoctor,
    type: 'child',
  },
  {
    path: BASEDIR + '/hospital/edit-doctor',
    component: EditDoctor,
    type: 'child',
  },
  {
    path: BASEDIR + '/hospital/doctor-profile',
  ...
  {
    path: BASEDIR + '/hospital/add-patient',
    component: AddPatient,
    type: 'child',
  },
  {
    path: BASEDIR + '/hospital/edit-patient',
    component: EditPatient,
    type: 'child',
  },
  {
    path: BASEDIR + '/hospital/patient-profile',
  ...
  {
    path: BASEDIR + '/hospital/doctor-schedule',
  ...
  {
    path: BASEDIR + '/hospital/reports-hospital',
    component: HospitalReportsHospital,
    type: 'child',
  },
  {
    path: BASEDIR + '/hospital/reports-patient',
    component: HospitalReportsPatient,
    type: 'child',
  },
  {
    path: BASEDIR + '/hospital/reports-sales',
    component: HospitalReportsSales,
    type: 'child',
  },
  {
    path: BASEDIR + '/hospital/reports-stats',
    component: HospitalReportsStats,
    type: 'child',
  },
  ...
  {
    path: BASEDIR + '/hospital/payments',
    component: HospitalPayments,
    type: 'child',
  },
  {
    path: BASEDIR + '/hospital/addpayment',
    component: HospitalAddPayment,
    type: 'child',
  },
  {
    path: BASEDIR + '/hospital/invoice',
    component: HospitalInvoice,
    type: 'child',
  },
  ...
  {
    path: BASEDIR + '/hospital/edit-staff',
    component: EditStaff,
    type: 'child',
  },
  {
    path: BASEDIR + '/hospital/staff-profile',
  ...
  {
    path: BASEDIR + '/hospital/locations',
    name: 'Locations',
    icon: 'directions',
    component: HospitalLocations,
  },
  ...
  {
    path: BASEDIR + '/hospital/mail-inbox',
    component: HospitalMailinbox,
    type: 'child',
  },
  {
    path: BASEDIR + '/hospital/mail-compose',
    component: HospitalMailcompose,
    type: 'child',
  },
  {
    path: BASEDIR + '/hospital/mail-view',
    component: HospitalMailview,
    type: 'child',
  },
